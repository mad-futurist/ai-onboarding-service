...
SIGNAL_CATALOG: list[SignalCatalogGroup] = [
    ...
    SignalCatalogGroup(
        ...
        items=[
            ...
            SignalCatalogItem(
                signal_type="price_list_friction",
                title="Price list confusion",
                tone="attention",
                severity="medium",
                when="The newcomer repeatedly asks about package prices, discount rules, or quoting guidance.",
                evidence="Recent AI questions and repeated price-list source usage.",
                suggested_action="Review package fit, discount approval rules, and value framing before live calls.",
                mvp_trigger="Ask 2+ price or discount questions in the AI assistant.",
            ),
            SignalCatalogItem(
                signal_type="company_info_friction",
                title="Company information confusion",
                tone="attention",
                severity="medium",
                when="The newcomer repeatedly asks how to explain the company, ICP, proof points, or buyer context.",
                evidence="Recent AI questions and repeated company-profile source usage.",
                suggested_action="Run a positioning walkthrough with ICP, proof points, and buyer-specific talk tracks.",
                mvp_trigger="Ask 2+ company-positioning questions in the AI assistant.",
            ),
            SignalCatalogItem(
